 ...
 * 
 */
public class GetOrderSystemCurrentInfoHandler extends DataHandler {
	private Context mContext;
	private String server_url;
	private PdaRequest<TmDispatchDto> orderDto;

	public GetOrderSystemCurrentInfoHandler(Context context,
			PdaRequest<TmDispatchDto> orderDto) {
		this.mContext = context;
		this.server_url = NetWork.GET_ORDER_SYSTEM_CURRENT_INFO_ACTION;
	...
	protected void onNetReceiveOk(byte[] receiveBody) {
		sendResult(NetWork.GET_ORDER_SYSTEM_CURRENT_INFO_OK, receiveBody);
	}

	@Override
	protected void onNetReceiveError(int errorCode) {
		sendResult(NetWork.GET_ORDER_SYSTEM_CURRENT_INFO_ERROR, errorCode);
	}
